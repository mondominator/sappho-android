...
val SapphoErrorBackground = Color(0xFF7F1D1D)  // Dark red background for error banners
val SapphoErrorText = Color(0xFFFECACA)  // Light pink text on error backgrounds
