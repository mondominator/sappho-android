...
const Color sapphoPrimaryDark = Color(0xFF3498DB); // Darker sky blue for gradients
const Color sapphoSecondary = Color(0xFF26A69A); // Teal accent (personal items)
const Color sapphoSecondaryDark = Color(0xFF00897B); // Darker teal for gradients
...
const Color sapphoSurfaceBorder = Color(0xFF3A3A3A); // Card border (improved contrast)
...
const Color sapphoTextSecondary = Color(0xFFB0B7BF); // Secondary text (5.5:1 contrast)
const Color sapphoTextMuted = Color(0xFF9CA3AF); // Muted/disabled text (4.5:1 contrast)
...
class LibraryGradients {
  ...
  static List<Color> forAvatar(String name) => forString(name, palette: avatars);
}
