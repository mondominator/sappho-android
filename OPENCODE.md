...
This file was migrated from CLAUDE.md for use with OpenCode. The content remains the same to ensure consistency across different AI assistants working on the project.

When using OpenCode:
- All the same principles and workflows apply
- Use the provided commands and architecture guidelines
- Follow the established patterns and conventions
- Maintain the code quality standards outlined above